#!/usr/bin/env python3
"""
Simple test script to send one message and collect responses
"""
...
async def main():
    ...
    logger.info("🚀 Simple Test for Telegram Bot")
    logger.info("=" * 40)
    ...
    try:
        ...
        logger.info("⏳ Waiting for bot responses (up to 180 seconds)...")
        await asyncio.sleep(30)  # Initial wait
        responses = await client.wait_for_responses(timeout=150)
        ...
        if responses:
            ...
            for response in responses:
                ...
                logger.info(f"Model {info['model_id']}: {response_text[:100]}...")
...
if __name__ == "__main__":
    try:
        ...
        if result:
            ...
            logger.info("❌ Simple test failed!")
            sys.exit(1)
