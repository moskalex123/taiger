#!/usr/bin/env python3
"""
Quick test script to send one message and collect any responses
"""
...
async def main():
    ...
    logger.info("🚀 Quick Test for Telegram Bot")
    logger.info("=" * 40)
    ...
    try:
        ...
        await asyncio.sleep(30)  # Give some time for processing
        responses = await client.wait_for_responses(timeout=90)
